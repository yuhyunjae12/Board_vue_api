...
public class SignController {
    ...
    public SingleResult<String> signin(@RequestBody ParamsUser param) {

        User user = userJpaRepo.findByUid(param.getId()).orElseThrow(CEmailSigninFailedException::new);
    ...
    public CommonResult signup(@RequestBody ParamsUser param) {
    ...
    @ApiOperation(value = "중복검사", notes = "아이디 중복검사를 한다.")
    @PostMapping(value = "/signup/idchk")
    public CommonResult idCheck(@RequestBody ParamsUser param) {
        return responseService.getSingleResult(userJpaRepo.existsByUid(param.getId()));
    }
}
