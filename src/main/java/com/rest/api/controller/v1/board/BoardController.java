...
import com.rest.api.annotation.ApiPageable;
...
import com.rest.api.model.response.PageResult;
...
public class BoardController {
    ...
    public PageResult<Post> posts(
    		@PageableDefault( size = 12) Pageable pageable, 
    		@PathVariable String boardName, 
    		String Keywordcolum,
    		String search) {
        return responseService.getPageResult(boardService.findPosts(boardName, Keywordcolum, search, pageable));
    }
